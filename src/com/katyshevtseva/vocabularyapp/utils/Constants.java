...
public class Constants {
    ...
    public static final String LISTS_CHOICE_WINDOW_TITLE = "Choose lists to learn";
    ...
    public static final int LIST_CHOICE_WINDOW_HEIGHT = 450;
    public static final int LIST_CHOICE_WINDOW_WIDTH = 450;
    public static final int WORD_SEARCH_WINDOW_HEIGHT = 500;
    public static final int WORD_SEARCH_WINDOW_WIDTH = 820;
    ...
    public static final int WARNING_WINDOW_WIDTH = 350;
    public static final int WORDS_LEARNING_WINDOW_HEIGHT = 500;
